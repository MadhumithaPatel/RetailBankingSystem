...
using AccountMicroservice.Provider;
using AccountTesting.ViewModel;
...
namespace AccountTesting
{
    ...
    public class AccountTest
    {
        ...
        //    var result = TokenObj.getAccountStatement(new StatementViewModel() { AccountId = 1, from_date = DateTime.Now, to_date = DateTime.Now });
        ...
        //    var result = TokenObj.getAccountStatement(new StatementViewModel() { AccountId = 0, to_date = DateTime.Now, from_date = DateTime.Now });
        ...
        public void deposit_Called_When_Given_Valid_AccountId()
        {
            ...
            var result = TokenObj.deposit(new AccountViewModels { AccountId = 1, amount = 200 });
        ...
        public void deposit_Called_When_Given_InValid_AccountId()
        {
            ...
            var result = TokenObj.deposit(new AccountViewModels { AccountId = 0, amount = 200 });
        ...
        public void withdraw_Called_When_Given_Valid_AccountId()
        {
            ...
            var result = TokenObj.withdraw(new AccountViewModels { AccountId = 1, amount = 200 });
        ...
        public void withdraw_Called_When_Given_InValid_AccountId()
        {
            ...
            var result = TokenObj.withdraw(new AccountViewModels { AccountId = 0, amount = 200 });
